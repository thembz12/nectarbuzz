...
const { loginUser, verifyEmail, resendVerificationEmail, forgotPassword, changePassword, resetPassword, getOne, logOut, farmerSignUp, updatePicture, updateUser} = require("../controller/FarmerController")
